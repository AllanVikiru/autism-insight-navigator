...
const UploadImage = () => {
  ...
  const handleImageSelected = (source: string) => {
    // Store image data in sessionStorage to access across pages
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8">
                Upload an image to analyze facial expressions and get personalized recommendations for supporting individuals with autism.
              </p>
              ...
              <div className="grid gap-8 md:grid-cols-3">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Upload an image showing facial expressions of the individual.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Our system analyzes the image to identify emotional patterns and expressions.
                  </p>
                </div>
